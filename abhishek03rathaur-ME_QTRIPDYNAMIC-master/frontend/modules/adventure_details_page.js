...
function addAdventureDetailsToDOM(adventure) {
  ...
  const h1Element = document.getElementById('adventure-name');
  h1Element.innerHTML=adventure.name;
 ...
 contentElement.innerHTML = adventure.content;
...
function calculateReservationCostAndUpdateDOM(adventure, persons) {
  ...
  document.getElementById('reservation-cost').innerHTML= parseInt(persons)*adventure.costPerHead;
